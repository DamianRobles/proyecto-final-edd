...
//* Implementación de operaciones - funciones
//! agregarInicio()
//! ==============================================================
void agregarInicio() {
...
void consultarLista() {
    ...
    while (apCopia != NULL) {
        cout << endl << endl;
        cout << "Dirección de memoria de este nodo: " << apCopia << endl;
        cout << "Listado de videojuegos" << endl;
        cout << "======================" << endl;
        ...
        cout << "Dirección de memoria del siguiente nodo: " << apCopia->next;
...
//! ==============================================================
    ...
    cout << "El videojuego con el titulo: " << titBuscar << " no fue localizado" << endl;
